...
?>
    <p>
        <strong>You are here:</strong> <a href="/">HOME</a> > <a href="<?php echo $post->category; ?>.php"><?php echo strtoupper($post->category); ?></a> > <a
                href="?id=<?php echo $post->id; ?>"><?php echo strtoupper($post->title); ?></a>
    </p>
        ...
        <div class="post-social">
            <table>
                <tr>
                    ...
                    <td>
                        <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(location.href), 'facebook-share-dialog', 'width=626,height=436'); return false;"><img
                                    src="/assets/images/share-button.png" style="border:none; height:20px;" title="Share on Facebook"/></a>
                    </td>
                    <td>
...
foreach ($comments as $comment) {
    ...
    <div class="post-comment">
        <i><strong><a href="/profile.php?user=<?php echo $comment->author; ?>" class="comment-author-link" style="color:<?php echo $color; ?>"><?php echo $comment->author; ?></a></strong></strong> at
            <strong><?php echo $time; ?></strong> on <strong><?php echo $date; ?></strong> (<?php echo $hours_ago; ?>)</strong></i><br/><br/>
            ...
            <center>
                <form action="comment-check.php" method="post">
                    <table>
                        <tr>
                            <td>Comment:</td>
                            <td><textarea name="comment-content" style="width:400px; height:100px;"></textarea></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <div class="g-recaptcha" data-sitekey="6LeXsf4SAAAAAF8YxjHnQw3VYqZPF9BQ79QR4osg"></div>
                                <input type="hidden" name="comment_author_status" value="admin"/>
                ...
                <form action="comment-check.php" method="post">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="g-recaptcha" data-sitekey="6LeXsf4SAAAAAF8YxjHnQw3VYqZPF9BQ79QR4osg"></div>
                                <input type="hidden" name="comment_author_status" value="mod"/>
                                <input type="hidden" name="post_id" value="<?php echo $post->id; ?>"/>
                            </td>
                        </tr>
                        <tr>
