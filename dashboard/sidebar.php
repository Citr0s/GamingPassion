...
<div id="wrapper">
    <div id="sidebar">
        ...
        <ul>
            <a href="/techblog/dashboard">
                <li id="dashboard-button"><i class="fa fa-home"></i> Dashboard</li>
            </a>
            <a href="new_article.php">
                <li id="new-articles-button"><i class="fa fa-pencil"></i> Create Article</li>
            </a>
            <a href="articles.php">
                <li id="articles-button"><i class="fa fa-file-text"></i> Articles</li>
            </a>
            <?php
            ...
            <a href="/techblog">
                <li style="border-bottom:1px solid #252525;"><i class="fa fa-sign-out"></i> Logout</li>
            </a>
        </ul>
        <center>
