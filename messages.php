...
?>
    ...
    <form method="post" action="message-check.php">
    	<table>
	    	<tr>
            	<td style="text-align:right;">Title:<span class="green-text">*</span></td><td><input type="text" name="title" /></td>
			</tr>
            <tr>
		    	<td style="text-align:right;">To:<span class="green-text">*</span></td><td><input type="text" name="to" /></td>
			</tr>
		    	<?php if(adminUser()){ echo '<tr><td align="right">Send to all:</td><td><input type="checkbox" name="send-to-all" style="width:15px; margin:10px;" /></td></tr>';}?>
            <tr>
            	<td style="text-align:right;" valign="top">Message:<span class="green-text">*</span></td><td><textarea style="width:400px; max-width:400px;" name="content"></textarea></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td></td><td><button type="submit" class="button">Send</button></td>
            </tr>
        </table>
    </form>
</div>
